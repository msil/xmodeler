...
import uk.ac.mdx.xmf.swt.editPart.GraphicalPartFactory;
import uk.ac.mdx.xmf.swt.editPart.RootEditPart;
...
public class ImageProducer {
	...
	public static ImageData getImageData(IFigure figure, int format) {
		...
		Graphics g = null;
		try {
			image = new Image(device, r.width + borderSize, r.height
					+ borderSize);
			gc = new GC(image);
